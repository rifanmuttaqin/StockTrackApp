...
class WhatsAppSettingUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'message_template.stock_opname' => 'nullable|array',
            'message_template.stock_opname.subject' => 'nullable|string|max:255',
            'message_template.stock_opname.opening' => 'nullable|string|max:500',
            'message_template.stock_opname.closing' => 'nullable|string|max:500',
            'message_template.stock_opname.body' => 'nullable|string|max:2000',
            'recipients' => 'nullable|array',
            'recipients.*' => 'exists:users,id',
            'notify_low_stock' => 'sometimes|boolean',
            'notify_out_of_stock' => 'sometimes|boolean',
            'notify_stock_opname' => 'sometimes|boolean',
    ...
    public function messages(): array
    {
        return [
            ...
            'notify_stock_opname.boolean' => 'Notifikasi stock opname harus berupa boolean',
