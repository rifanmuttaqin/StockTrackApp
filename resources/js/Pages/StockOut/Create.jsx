    ...
    return (
      ...
      >
        ...
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
          ...
          <div className="md:flex md:items-center md:justify-between mb-6">
            <div className="flex-1 min-w-0">
              ...
              <p className="mt-1 text-sm text-gray-500">
                Masukkan data stock keluar berdasarkan template aktif
              </p>
            </div>
          </div>
          ...
          <Alert
            type="error"
            message="Tidak ada template aktif. Silakan aktifkan template terlebih dahulu sebelum melakukan input stock keluar."
            className="mb-6"
          />
      ...
      <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 pb-20 sm:pb-0">
        ...
        <div className="md:flex md:items-center md:justify-between mb-6">
          <div className="flex-1 min-w-0">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Masukkan data stock keluar berdasarkan template: {activeTemplate.name}
            </p>
          </div>
        ...
        <div className="bg-white shadow overflow-hidden sm:rounded-lg">
          <MobileForm>
            ...
            <MobileFormSection
              ...
              description="Masukkan tanggal stock keluar"
        ...
        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-blue-800">Tips Input Stock Keluar</h3>
